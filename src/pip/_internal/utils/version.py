...
class ParsedVersion:
    ...
    def parse(cls, version: str) -> Self:
        ...
        return cls(
            ...
            pre=cls._parse_letter_version(g["pre_l"], g["pre_n"]),
            _post=cls._parse_letter_version(g["post_l"], g["post_n1"] or g["post_n2"]),
            _dev=cls._parse_letter_version(g["dev_l"], g["dev_n"]),
            _local=cls._parse_local_version(g["local"]),
        )
    ...
    def _key(
        ...
        _local = type(self)._cmp_local(self._local)
